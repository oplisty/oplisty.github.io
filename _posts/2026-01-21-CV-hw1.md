 ...
 **1. The bright rows show the large distances between the test sample and all the training samples ,which is usually mean that it is so diffrent from the training set.**

**2. The bright columns show that the distance between the training sample and all the test samples are large,which is  usually mean that the training sample is a outlier **
