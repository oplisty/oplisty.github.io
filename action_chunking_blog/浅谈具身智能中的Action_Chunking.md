...
![Action Chunking 的机制分解](assets/01_why_action_chunking.png)
...
![真机实验中不同策略的对比](assets/02_realworld_chunking.png)
...
![不同 horizon 在 π0 上表现出明显权衡](assets/03_horizon_tradeoff.png)
...
![Mixture of Horizons 架构](assets/04_moh_architecture.png)
...
![MoH 的动态推理](assets/05_moh_dynamic_inference.png)
...
![PACE 总览](assets/06_pace_overview.png)
...
![PACE 在单条 rollout 中动态改变执行长度](assets/08_pace_adaptive_rollout.png)
...
![更长的训练 prediction horizon 能改善被执行的短前缀](assets/07_pace_training_horizon.png)
